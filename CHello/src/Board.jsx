...
import { addDoc, collection, query, orderBy, onSnapshot, doc, getDocs, updateDoc, arrayUnion, getFirestore} from "firebase/firestore";
...
const Board = () => {
    ...
    const boardRef = collection(db, `workspaces/${id}/board`)
    const allBoard = []
    ...
    useEffect(()=>{
        let q = query(boardRef, orderBy('title', 'asc'));
        const board = [];
