      ...
      <div className="flex flex-col h-0 flex-1">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          <nav className="flex-1 px-4 py-4 bg-khaki space-y-3 spacex-2">
            <a href="#" className="bg-green text-2xl hover:bg-teal text-cream group flex items-center px-2 py-2 text-sm font-medium rounded-md ">
              Workspaces
            </a>
      ...
      <div className="py-8 px-5"> 
        <div className="max-w-7xl space-x-4">
          ...
          <form onSubmit={createWS} className="max-w-4xl space-x-4 flex-col space-y-3">
            ...
            <select onChange={(e) => setType(e.target.value)} placeholder='Type' className="text-white form-select form-select-lg mb-3 w-30 h-10 mt-6 pl-4 pr-4 bg-khaki rounded-md">
                <option className='text-white' value="Type">Type</option>
                <option className='text-white' value="Public">Public</option>
                <option className='text-white' value="Private">Private</option>
            </select>
           <button className="bg-green hover:bg-teal w-1/2 text-cream pl-4 space-x-4 ml-0 py-2 px-10 border-b-4 border-green hover:border-teal rounded-md ">Create Workspace</button>
          </form>
          <br />
