...
const Board = () => {
    ...
    useEffect(()=>{
        const boardQ = query(boardRef, where('visibility', '==', 'Public'), where('status', '==', 'open'), where('workspaceID', '==', id))
        const board = [];
    ...
    <div className="flex flex-col w-0 flex-1 overflow-hidden">
        ...
        <div className="flex-1 px-4 flex justify-between bg-cream">
            ...
            <form className="w-full flex md:ml-0 " action="#" method="GET">
                ...
                <input onChange={(e)=>setSearch(e.target.value)} id="search_field" className=" w-full h-full pl-8 pr-3 py-2 text-black border-transparent bg-cream placeholder-black focus:outline-none focus:placeholder-black focus:ring-0 focus:border-transparent sm:text-sm" placeholder="Search" type="search" name="search"></input>
                </div>
            </form>
            </div>
        ...
        <main className="flex-1 relative overflow-y-auto focus:outline-none bg-cream pt-4 pl-2" >
            <h1 className="text-4xl font-semibold text-gray-900 pl-4">Board</h1>
